 ...
 * @LastEditTime: 2021-03-18 10:10:04
 */
...
OPERATE_RET app_compass_init(IN APP_COMPASS_MODE mode)
{
...
VOID app_report_all_dp_status(VOID)
{
    ...
    dp_arr[0].dpid = DPID_DIRECTION_ANGLE;
    dp_arr[0].type = PROP_VALUE;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = app_ctrl_data.angle;
